...
/** Abstract implementation of a JSON service. */
public abstract class JsonServiceImpl<T> {
    /** JSON ObjectMapper. */
     ...
     */
    public T fromJson(String json) throws JsonMappingException, JsonProcessingException {
        return jsonMapper.readValue(json, getParameterClass());
    }
